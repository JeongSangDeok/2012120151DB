  ...
  <form method = "post" action = "sql_bookinsert.php" >
     <fieldset>
        ...
        도서유형: <input type="text" name="Booktype" size = "25" list = "listid"/> <br>
                  <datalist id = "listid"> 
                      <option value = "abook" label="단행본"/>
                      <option value="academic" label = " 학술지"/>
                      <option value = "nonebook" label="비도서"/>
                  </datalist>
        저자: <input type="text" name="Bookwriter" size = "25"/> <br>
        가격 : <input type = "number" name = "Bookprice" min = "1000" max="20000" step="1000" value="10000"/> <br>
        출판사: <input type="text" name="Bookpublisher" size = "25" list = "list_publish"/> <br>
        ...
        출간날짜 : <input type = "date" name ="Bookdate" min ="1999-10-02" max = "2020-10-02" value = "2016-04-17"/> <br>
        권수 : <input type = "number" name = "Booknum" min = "0" max = "10" step="1" value = "0"/> <br> <br>
