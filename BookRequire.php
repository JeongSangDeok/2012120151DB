...
<body>
  <form method = "post" action = "sql_bookrequire.php" oninput="sum.value = parseInt(Bookprice.value) * parseInt(Booknum.value)">
  ...
  <fieldset>
     ...
     권수 : <input type = "number" name = "Booknum" min = "0" max = "10" step="1" value = "0"/> <br>
     합계 : <output name = "sum"> </output> <br> <br>
